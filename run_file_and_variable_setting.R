...
# COMPUTER TYPE
# Enter whether you are using a PC or Mac.
...
# DATA FILE TYPE
# Enter the extension for your data file (e.g., txt, xlsx, or csv).
# Currently, only .txt, .csv and .xlsx files are supported, although
...
load_packages <- paste(wd, slash, "load_packages.R", sep="")
run_file <- paste(wd, slash, "r_script_pdf.R", sep="")
